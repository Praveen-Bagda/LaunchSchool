...
#   1. Can use exising methods defined in other classes and modules.
#   2. Namespacing
#   3. We can hide the implementation detail and control the access to methods through accessor methods.
...
#   namespace issues are much harder to come across.
# 4. It allows us to easily give functionality to different parts of an application without
#   duplication.
